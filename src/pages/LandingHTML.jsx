...
export const LandingHTML = () => {
  ...
  const schemaMarkup = {
    ...
    'hasPart': htmlModule.sections.flatMap((section, idx) =>
  ...
  return (
    <>
      ...
      <div className="html-landing">        {/* Hero Section */}
        <LandingHero
          title="HTML: Estructura de la Web"
          subtitle="El lenguaje fundacional de internet"
          description="HTML es el lenguaje de markup que estructura el contenido web. Desde elementos semánticos hasta formularios y multimedia, HTML proporciona la base sobre la cual se construyen todas las páginas web modernas."
          primaryColor={landingTheme.primary}
          darkColor={landingTheme.dark}
          lightGradientColor={landingTheme.lightGradient}
          primaryButtonText="Comenzar con HTML →"
          primaryButtonLink="/frontend/html"
          secondaryButtonText="Ver comparativa"
          secondaryButtonLink="#comparativa"
          imageUrl="/src/assets/images/logos/html-logo.png"
          imageAlt="HTML Logo"
        />
        ...
        <section className="learning-topics">
          <div className="content-container">
            ...
            <div className="theme-cards-container">
              {htmlModule.sections.map((section, idx) => (
                <KotlinThemeCard
                  key={idx}
                ...
                <tbody>
                  {comparisonData.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      <td className="html-col">{row.kubernetes}</td>
        ...
        <section className="html-cta">
          <div className="cta-content">
            ...
            <Link to="/frontend/html" className="cta-button">
