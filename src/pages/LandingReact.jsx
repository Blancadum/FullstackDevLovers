...
export const LandingReact = () => {
  const theme = getTheme('react');
  const reactModule = getModule('react');
  const [openFaqIndex, setOpenFaqIndex] = useState(null);

  // Aplicar tema dinámico con variables CSS
  const landingTheme = getThemeByModule('react');
  useLandingTheme(landingTheme.primary, landingTheme.dark, landingTheme.lightGradient);

  if (!reactModule) return null;

  // Schema Markup para JSON-LD
  const schemaMarkup = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    'name': 'React - Librería de JavaScript para Interfaces | Guía Completa',
    'description': 'Aprende React: componentes, hooks, state management y desarrollo de SPAs modernas.',
    'provider': {
      '@type': 'Organization',
      'name': 'Fullstack Dev Lovers',
      'url': 'https://fullstackdevlovers.com'
    },
    'url': 'https://fullstackdevlovers.com/frontend/react',
    'hasPart': reactModule.sections.flatMap((section, idx) =>
  ...
  const faqData = [
    ...
    {
      question: '¿React vs Angular vs Vue: cuál elegir?',
  ...
  return (
    <>
      <SEO
        title="React - Librería de JavaScript para Interfaces | Guía Completa | Guía Completa"
        ...
        keywords="react, javascript, componentes, hooks, usestate, virtual dom, frontend, spa"
        url="https://fullstackdevlovers.com/frontend/react"
      ...
      <div className="react-landing">        {/* Hero Section */}
        <LandingHero
          title="React: La Librería de JavaScript para Interfaces Dinámicas"
          subtitle="Desarrollado y mantenido por Meta (Facebook)"
          description="React es la librería de JavaScript más popular para construir interfaces dinámicas e interactivas. Con componentes reutilizables, virtual DOM para mejor performance, y un ecosistema masivo, React permite construir desde SPAs complejas hasta aplicaciones mobile nativas con React Native."
          primaryColor={landingTheme.primary}
          darkColor={landingTheme.dark}
          lightGradientColor={landingTheme.lightGradient}
          primaryButtonText="Comenzar con React →"
          primaryButtonLink="/frontend/react"
        ...
        <section className="react-content">
          <div className="content-container">
            ...
            <p className="intro-text">
              React es una librería de JavaScript desarrollada por Facebook (Meta) para construir interfaces de usuario con componentes reutilizables. Su enfoque reactivo, virtual DOM, y ecosistema permite desarrollar aplicaciones complejas con mejor mantenibilidad y performance. para gestionar aplicaciones containerizadas
        ...
        <section className="learning-topics">
          <div className="content-container">
            ...
            <p className="intro-text">
              Domina React con una progresión estructurada desde conceptos básicos hasta orquestación avanzada
            </p>

            <div className="theme-cards-container">
              {reactModule.sections.map((section, idx) => (
                <KotlinThemeCard
                  key={idx}
        ...
        <section className="comparison-section" id="comparativa">
          <div className="content-container">
            ...
            <p className="intro-text">
              Comparativa detallada de React con otras plataformas de orquestación
            </p>
                ...
                <tbody>
                  {comparisonData.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      <td className="react-col">{row.kubernetes}</td>
        ...
        {/* CTA Final Section */}
        <section className="react-cta">
          <div className="cta-content">
            <h2>Comienza tu Viaje con React</h2>
            <p>Aprende desde conceptos básicos hasta nivel profesional</p>
            <Link to="/frontend/react" className="cta-button">
              Ir a Fundamentos de React →
            </Link>
          </div>
        </section>
      </div>
