...
export const LandingMongoDB = () => {
  const theme = getTheme('mongodb');
  const mongodbModule = getModule('mongodb');
  const [openFaqIndex, setOpenFaqIndex] = useState(null);

  // Aplicar tema dinámico con variables CSS
  const landingTheme = getThemeByModule('mongodb');
  ...
  const schemaMarkup = {
    ...
    'hasPart': mongodbModule.sections.flatMap((section, idx) =>
  ...
  return (
    <>
      ...
      <div className="mongodb-landing">        {/* Hero Section */}
        <LandingHero
          title="MongoDB: Base de Datos NoSQL"
          subtitle="Documentos JSON escalables y flexibles"
          description="MongoDB es una base de datos NoSQL orientada a documentos que permite almacenar datos en formato JSON flexible. Perfecta para aplicaciones modernas que necesitan escalabilidad horizontal y esquemas dinámicos."
          primaryColor={landingTheme.primary}
          darkColor={landingTheme.dark}
          lightGradientColor={landingTheme.lightGradient}
          primaryButtonText="Comenzar con MongoDB →"
          primaryButtonLink="/datos/mongodb"
        ...
        <section className="mongodb-content">
        ...
        <section className="learning-topics">
          <div className="content-container">
            ...
            <div className="theme-cards-container">
              {mongodbModule.sections.map((section, idx) => (
                <KotlinThemeCard
                  key={idx}
                ...
                <tbody>
                  {comparisonData.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      <td className="mongodb-col">{row.kubernetes}</td>
        ...
        <section className="mongodb-cta">
          <div className="cta-content">
            ...
            <Link to="/datos/mongodb" className="cta-button">
