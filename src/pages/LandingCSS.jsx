...
export const LandingCSS = () => {
  ...
  const schemaMarkup = {
    ...
    'hasPart': cssModule.sections.flatMap((section, idx) =>
  ...
  return (
    <>
      ...
      <div className="css-landing">        {/* Hero Section */}
        <LandingHero
          title="CSS: Estilos Web Profesionales"
          subtitle="El lenguaje esencial para diseño web"
          description="CSS es el lenguaje de estilos fundamental para web. Desde selectores básicos hasta Grid y Flexbox, CSS permite crear layouts profesionales, animaciones suaves, y responsive design que funcionan en todos los dispositivos."
          primaryColor={landingTheme.primary}
          darkColor={landingTheme.dark}
          lightGradientColor={landingTheme.lightGradient}
          primaryButtonText="Comenzar con CSS →"
          primaryButtonLink="/frontend/css"
        ...
        <section className="learning-topics">
          <div className="content-container">
            ...
            <div className="theme-cards-container">
              {cssModule.sections.map((section, idx) => (
                <KotlinThemeCard
                  key={idx}
                ...
                <tbody>
                  {comparisonData.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      <td className="css-col">{row.kubernetes}</td>
        ...
        <section className="css-cta">
          <div className="cta-content">
            ...
            <Link to="/frontend/css" className="cta-button">
