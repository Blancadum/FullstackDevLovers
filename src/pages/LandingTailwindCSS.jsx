...
export const LandingTailwindCSS = () => {
  const theme = getTheme('tailwindcss');
  const tailwindcssModule = getModule('tailwindcss');
  const [openFaqIndex, setOpenFaqIndex] = useState(null);

  // Aplicar tema dinámico con variables CSS
  const landingTheme = getThemeByModule('tailwindcss');
  useLandingTheme(landingTheme.primary, landingTheme.dark, landingTheme.lightGradient);

  if (!tailwindcssModule) return null;
  ...
  const schemaMarkup = {
    ...
    'hasPart': tailwindcssModule.sections.flatMap((section, idx) =>
  ...
  return (
    <>
      ...
      <div className="tailwindcss-landing">        {/* Hero Section */}
        <LandingHero
          title="Tailwind CSS: Utility-First Framework"
          subtitle="Construye diseños rápidamente sin CSS personalizado"
          description="Tailwind CSS es un framework utility-first que permite construir interfaces modernas aplicando clases CSS predefinidas. Sin necesidad de escribir CSS personalizado, Tailwind acelera el desarrollo y mejora la consistencia visual."
          primaryColor={landingTheme.primary}
          darkColor={landingTheme.dark}
          lightGradientColor={landingTheme.lightGradient}
          primaryButtonText="Comenzar con Tailwind CSS →"
          primaryButtonLink="/frontend/tailwindcss"
        ...
        <section className="tailwindcss-content">
        ...
        <section className="learning-topics">
          <div className="content-container">
            ...
            <div className="theme-cards-container">
              {tailwindcssModule.sections.map((section, idx) => (
                <KotlinThemeCard
                  key={idx}
                ...
                <tbody>
                  {comparisonData.map((row, idx) => (
                    <tr key={idx}>
                      ...
                      <td className="tailwindcss-col">{row.kubernetes}</td>
        ...
        {/* CTA Final Section */}
        <section className="tailwindcss-cta">
          <div className="cta-content">
            ...
            <Link to="/frontend/tailwindcss" className="cta-button">
