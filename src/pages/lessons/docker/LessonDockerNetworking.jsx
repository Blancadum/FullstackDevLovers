...
export function LessonDockerNetworking() {
  ...
  const concepts = [
    { title: 'Bridge Network', definition: 'Red por defecto que conecta contenedores', example: 'Localhost para host, DNS por nombre entre contenedores' },
    { title: 'Host Network', definition: 'Usa red del host directamente', example: 'Sin aislamiento de red, máximo rendimiento' },
    { title: 'None Network', definition: 'Sin conectividad de red', example: 'Contenedor completamente aislado' },
    { title: 'DNS Interno', definition: 'Resolución de nombres entre contenedores', example: 'Acceder a "db" en lugar de 172.18.0.2' },
    { title: 'Port Mapping', definition: 'Exponer puertos del contenedor al host', example: '-p 8080:3000 mapea host:3000 → contenedor:3000' },
    { title: 'Container Linking', definition: 'Conectar contenedores (deprecated, usar networks)', example: '--link db:database (evitar en favor de custom networks)' }
  ];
