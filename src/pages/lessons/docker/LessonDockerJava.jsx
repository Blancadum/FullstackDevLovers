...
export function LessonDockerJava() {
  ...
  const concepts = [
    { title: 'Java', definition: 'Lenguaje compilado, Spring Boot popular', example: 'java -jar app.jar' },
    { title: 'Spring Boot', definition: 'Framework web embebido (sin Tomcat separado)', example: 'jar incluye servidor' },
    { title: 'Maven', definition: 'Build tool, genera JAR', example: 'mvn clean package' },
    { title: 'Multi-stage', definition: 'Compilar en Maven, ejecutar con JRE slim', example: 'Maven (900MB) → JRE (200MB)' },
    { title: 'JRE vs JDK', definition: 'Runtime vs Development, usar JRE', example: 'openjdk:11-jre-slim' },
    { title: 'Startup', definition: 'Java tarda en arrancar, caché importante', example: 'Maven depency:resolve primero' }
  ];
