...
export function LessonDockerPython() {
  ...
  const concepts = [
    { title: 'Python', definition: 'Lenguaje interpretado, Flask/FastAPI populares', example: 'FastAPI server.py' },
    { title: 'pip', definition: 'Gestor de paquetes de Python', example: 'pip install -r requirements.txt' },
    { title: 'requirements.txt', definition: 'Dependencias del proyecto', example: 'fastapi==0.95.0' },
    { title: 'Uvicorn', definition: 'Servidor ASGI para Python', example: 'uvicorn main:app' },
    { title: 'venv', definition: 'Entorno virtual (NO necesario con Docker)', example: 'En Docker: no usar venv' },
    { title: '--no-cache-dir', definition: 'No guardar paquetes descargados', example: 'pip install --no-cache-dir' }
  ];
