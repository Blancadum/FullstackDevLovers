...
export function LessonDockerDebugging() {
  ...
  const concepts = [
    { title: 'Logs', definition: 'Salida estándar y errores del contenedor', example: 'docker logs -f mi-contenedor' },
    { title: 'exec', definition: 'Ejecutar comandos dentro del contenedor', example: 'docker exec -it mi-contenedor bash' },
    { title: 'inspect', definition: 'Detalles completos del contenedor en JSON', example: 'docker inspect mi-contenedor' },
    { title: 'stats', definition: 'Monitoreo en tiempo real de recursos', example: 'docker stats' },
    { title: 'cp', definition: 'Copiar archivos del/al contenedor', example: 'docker cp mi-contenedor:/logs ./logs-backup' },
    { title: 'diff', definition: 'Ver cambios de archivos en contenedor', example: 'docker diff mi-contenedor' }
  ];
