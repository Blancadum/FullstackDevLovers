...
export function LessonDockerPracticas() {
  ...
  const concepts = [
    { title: 'Versionado', definition: 'Etiquetar imágenes con versiones semánticas', example: 'mi-app:1.0.0, mi-app:latest' },
    { title: 'Seguridad', definition: 'No executar como root, escanear vulnerabilidades', example: 'docker scan mi-app' },
    { title: 'Logging', definition: 'Enviar logs a sistemas centralizados', example: 'ELK, Splunk, CloudWatch' },
    { title: 'CI/CD', definition: 'Automatizar build y push de imágenes', example: 'GitHub Actions, GitLab CI' },
    { title: 'Monitoreo', definition: 'Prometheus, Grafana para métricas', example: 'CPU, memoria, latencia' },
    { title: 'Registry', definition: 'Almacenar imágenes privadamente o públicamente', example: 'Docker Hub, ECR, GCR' }
  ];
