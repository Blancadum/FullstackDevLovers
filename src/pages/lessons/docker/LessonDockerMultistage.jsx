...
export function LessonDockerMultistage() {
  ...
  const concepts = [
    { title: 'Builder Stage', definition: 'Etapa de construcción con herramientas pesadas', example: 'Node:18 (600MB) para compilar' },
    { title: 'Runtime Stage', definition: 'Etapa ligera con solo lo necesario', example: 'Nginx:alpine (40MB) para servir' },
    { title: 'AS alias', definition: 'Nombra etapas para referencias cruzadas', example: 'FROM node:18 AS builder' },
    { title: 'COPY --from', definition: 'Copia solo lo necesario de etapa anterior', example: 'COPY --from=builder /app/dist .' },
    { title: 'Tamaño reducido', definition: 'Imagen final mucho más pequeña', example: '1.5GB → 50MB' },
    { title: 'Rendimiento', definition: 'Builds más rápidos, descarga más veloz', example: 'Menos datos = menos tiempo' }
  ];
