...
export function LessonDockerVolumenes() {
  ...
  const concepts = [
    { title: 'Named Volume', definition: 'Volumen gestionado por Docker con nombre', example: 'docker volume create datos' },
    { title: 'Bind Mount', definition: 'Mapeo directo de carpeta local al contenedor', example: '-v /local/path:/container/path' },
    { title: 'Volume Driver', definition: 'Plugin para gestionar almacenamiento', example: 'local, nfs, etc' },
    { title: 'Persistencia', definition: 'Datos que sobreviven al contenedor', example: 'Bases de datos, archivos de upload' },
    { title: 'Volumen Anónimo', definition: 'Volumen temporal sin nombre', example: '-v /app/data (se elimina con contenedor)' },
    { title: 'read-only', definition: 'Montar volumen como solo lectura', example: '-v datos:/app/data:ro' }
  ];
