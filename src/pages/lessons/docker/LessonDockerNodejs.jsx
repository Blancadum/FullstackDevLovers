...
export function LessonDockerNodejs() {
  ...
  const concepts = [
    { title: 'Node.js', definition: 'Runtime JavaScript, Express popular', example: 'node server.js' },
    { title: 'npm', definition: 'Gestor de paquetes, package.json', example: 'npm install' },
    { title: 'package.json', definition: 'Dependencias y scripts', example: 'npm start, npm test' },
    { title: 'node_modules', definition: 'Directorio de dependencias (GORDO)', example: '100-500MB' },
    { title: 'Alpine', definition: 'Versión ligera de Node', example: 'node:18-alpine (170MB)' },
    { title: 'nodemon', definition: 'Auto-reload en desarrollo', example: 'npm i -D nodemon' }
  ];
