...
export function LessonDockerFrontend() {
  ...
  const concepts = [
    { title: 'React', definition: 'SPA compilada a HTML/JS/CSS estático', example: 'npm run build → dist/' },
    { title: 'Build', definition: 'Compilación a archivos estáticos', example: 'webpack, vite, etc' },
    { title: 'Web Server', definition: 'Nginx/Apache sirven archivos estáticos', example: 'nginx:alpine' },
    { title: 'Node Builder', definition: 'Imagen pesada solo para compilar', example: 'node:18 (600MB)' },
    { title: 'Nginx Runtime', definition: 'Imagen ligera solo para servir', example: 'nginx:alpine (40MB)' },
    { title: 'COPY --from', definition: 'Trae build output de etapa anterior', example: 'COPY --from=builder /app/dist .' }
  ];
