import { LessonTemplate, CodeBlock, InfoBox, Table, LessonConceptGrid, LessonKeyPoints, LessonExercises, LessonSummary } from '../../../components';
...
class Excel extends Documento { }`}
    ...
    },
    {
      ...
      content: (
        <>
          <InfoBox type="warning" title=" Confusión Común">
...
•  ¿Confundido con Interfaces? Ver comparativa en Interfaces y Clases Abstractas`;
