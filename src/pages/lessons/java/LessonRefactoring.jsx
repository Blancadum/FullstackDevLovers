...
export function LessonRefactoring() {
  ...
  const concepts = [
    { title: 'Refactorización', definition: 'Proceso de reestructurar código sin cambiar funcionalidad', example: 'Renombrar variables, extraer métodos' },
    { title: 'Código Limpio', definition: 'Código que es fácil de leer, mantener y entender', example: 'Nombres claros, funciones pequeñas' },
    { title: 'SOLID', definition: 'Principios de diseño para código mantenible', example: 'S: Single Responsibility, O: Open/Closed' },
    { title: 'DRY (Don\'t Repeat Yourself)', definition: 'Eliminar duplicación de código', example: 'Extraer lógica común en funciones' },
  ];
