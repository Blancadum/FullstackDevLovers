    ...
    >
      ...
      <LessonSection title="Los IDEs más conocidos" level={1}>
        ...
        <div style={{
          ...
          {[
            { name: 'Eclipse', link: '/entornos/herramientas/ides/eclipse', desc: 'Libre, modular, basado en plugins' },
            { name: 'IntelliJ IDEA', link: '/entornos/herramientas/ides/intellij', desc: 'Profesional, potente, enfoque UX' },
            { name: 'VS Code', link: '/entornos/herramientas/ides/vscode', desc: 'Ligero, versátil, múltiples lenguajes' }
          ].map((ide, idx) => (
            <Link
              key={idx}
              to={ide.link}
