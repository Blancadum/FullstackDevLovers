      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li> <strong>Reducción de errores:</strong> menos typos, sintaxis correcta</li>
          ...
          <ul>
            <li> <strong>No entiende contexto profundo:</strong> puede generar código que compila pero es ineficiente</li>
            <li> <strong>Dependencia:</strong> si siempre dejas que IA escriba, no aprendes realmente</li>
            <li> <strong>Privacidad:</strong> (Copilot) envía código a servidores de OpenAI</li>
            <li> <strong>Datos de entrenamiento:</strong> Codeium entrenó en código de GitHub (posibles copyright issues)</li>
          </ul>
