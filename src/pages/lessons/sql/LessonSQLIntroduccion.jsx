import { LessonTemplate, CodeBlock, InfoBox, LessonConceptGrid, LessonKeyPoints, LessonExercises, LessonSummary } from '../../../components';
  ...
  const sections = [
    {
      ...
      content: (
        <>
          <p>
            Una <strong>base de datos</strong> es un conjunto de datos organizados de manera estructurada, almacenados
...

    {
      ...
      content: (
        <>
          <p>Una <strong>tabla</strong> está compuesta por:</p>
          <ul>
            ...
            <li><strong>Tipos de Datos:</strong> <strong>VARCHAR</strong>, <strong>INT</strong>, <strong>DATETIME</strong>, <strong>DECIMAL</strong>, etc.</li>
            <li><strong>Restricciones:</strong> <strong>PRIMARY KEY</strong>, <strong>FOREIGN KEY</strong>, <strong>UNIQUE</strong>, <strong>NOT NULL</strong></li>
          </ul>
...
Filas: 2 registros de usuario`} />
...

    {
      ...
      content: (
        <>
          <p>Las <strong>relaciones</strong> conectan <strong>tablas</strong> permitiendo consultas complejas:</p>
