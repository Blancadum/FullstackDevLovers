...

    {
      ...
      content: (
        <>
          ...
          <InfoBox type="warning" title=" Advertencia crítica">
        ...
        <>
          ...
          <Table
            ...
            rows={[
              ...
              ['SDK Java + Spring Boot', ' Mejor integración', ' Buena', ' Buena', 'AWS ventaja'],
              ['Documentación y comunidad', ' Más extensa', ' Muy buena', ' Buena', 'AWS ventaja'],
              ['Curva de aprendizaje', ' Elevada', ' Elevada', ' Media', 'Similares'],
              ['Vendor lock-in', ' Alto (servicios propios)', ' Alto', ' Medio', 'Riesgo gestionable'],
