          ...
          <div style={{
            ...
            {[
              ...
              onMouseLeave={(e) => {
                ...
                <div style={{ marginBottom: '1rem' }}>
                  <p style={{ fontSize: '0.85rem', fontWeight: '600', color: '#d32f2f', marginBottom: '0.5rem' }}> Desventajas:</p>
                  <ul style={{ margin: 0, paddingLeft: '1.5rem', fontSize: '0.9rem', color: '#555', lineHeight: '1.5' }}>
          ...
          <div style={{
            ...
            {[
              ...
              onMouseLeave={(e) => {
                ...
                <div style={{ marginBottom: '1rem' }}>
                  <p style={{ fontSize: '0.85rem', fontWeight: '600', color: '#d32f2f', marginBottom: '0.4rem' }}> Limitaciones:</p>
                  <ul style={{ margin: 0, paddingLeft: '1.5rem', fontSize: '0.85rem', color: '#555', lineHeight: '1.4' }}>
      ...
      content: (
        <>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#E65100', marginTop: 0, fontSize: '1.2rem' }}> Checklist de Seguridad Antes de Elegir Proveedor</h3>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#4A148C', marginTop: 0, fontSize: '1.2rem' }}> Errores Comunes de Seguridad en Cloud</h3>
      ...
      content: (
        <>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#c62828', marginTop: 0, fontSize: '1.2rem' }}> Errores Comunes que Aumentan Costos</h3>
            <ul style={{ fontSize: '0.95rem', lineHeight: '1.8', margin: 0, paddingLeft: '1.5rem', color: '#333' }}>
        ...
        <>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
            ...
            <div style={{
              ...
              <h3 style={{ color: '#c62828', marginTop: 0 }}> Debilidades/Desafíos</h3>
              <ul style={{ fontSize: '0.95rem', lineHeight: '1.8', margin: 0 }}>
      ...
      content: (
        <>
          ...
          <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '1.5rem', color: '#c62828' }}>
            <strong> Mantén on-premise si:</strong>
          </p>
