...
export function LessonAWSEC2() {
  ...
  const sections = [
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
              {[
                { state: 'pending', desc: 'Se está iniciando. Durará unos segundos.' },
                { state: 'running', desc: 'En funcionamiento. Se cobra tarifa normal.' },
                { state: 'stopping', desc: 'Se está deteniendo. Transición rápida.' },
                { state: 'stopped', desc: 'Detenida. No se cobra computación, sí EBS.' },
                { state: 'terminating', desc: 'Se está terminando (irreversible).' },
                { state: 'terminated', desc: 'Terminada. No se cobra. No se puede reiniciar.' }
              ].map((s, idx) => (
    ...
    {
      title: 'Caso Práctico: StreamFlow',
      content: (
        <>
          <p style={{ fontSize: '1.1rem', lineHeight: '1.8', marginBottom: '1.5rem' }}>
            ¿Quieres ver cómo una startup de video streaming (StreamFlow) escaló de 100 a 500K usuarios usando EC2 con Auto Scaling?
          </p>
          <div style={{
