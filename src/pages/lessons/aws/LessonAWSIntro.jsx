...
$ $25-100 USD/mes para aplicación pequeña`}
        ...
        <>
          ...
          <div style={{ marginTop: '2rem' }}>
            {[
              {
                step: 1,
                title: 'Crear VPC (Red Privada)',
                description: 'Configura una red privada aislada donde vivirán todos tus recursos',
                command: 'aws ec2 create-vpc --cidr-block 10.0.0.0/16'
              },
              {
                step: 2,
                title: 'Lanzar Instancia EC2',
                description: 'Despliega máquinas virtuales que ejecutarán tu aplicación',
  ...
  --key-name mi-llave`
              ...
              {
                step: 3,
                title: 'Crear Base de Datos RDS',
                description: 'Configura una base de datos PostgreSQL administrada automáticamente',
  ...
  --master-username admin`
              },
              {
                ...
                description: 'Almacena imágenes, documentos y archivos multimedia de tu aplicación',
                command: 'aws s3 mb s3://mi-app-imagenes'
              },
              {
                step: 5,
                title: 'Monitorear en CloudWatch',
                description: 'Configura alertas automáticas para notificarte de problemas',
  ...
  --threshold 80`
              ...
              <div key={item.step} style={{
                ...
                <div style={{
                  ...
                  <h4 style={{ margin: 0, fontSize: '1.1rem', color: '#2196F3' }}>
                    {item.title}
                  </h4>
                </div>
                <p style={{
