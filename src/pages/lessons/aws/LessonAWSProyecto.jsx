...
export const LessonAWSProyecto = () => {
  ...
  const sections = [
    ...
    { id: 'arquitectura', title: ' Arquitectura de Referencia' },
  ...
  return (
    <>
      ...
      {(expandedSection === null || expandedSection === 'arquitectura') && (
        <section className="lesson-section">
          <h2> Arquitectura de Referencia Completa</h2>
  ...
  - Interrupción tolerable para testing`}
      ...
      {(expandedSection === null || expandedSection === 'justificacion') && (
        <section className="lesson-section">
          ...
          <div className="info-box">
            <strong> Nota importante:</strong> La elección de AWS no significa que sea "la mejor"
