...
export function LessonSpringBatch() {
  ...
  const concepts = [
    { title: 'Job', definition: 'Unidad de trabajo que se ejecuta - contiene uno o más steps', example: 'Importar millones de registros' },
    { title: 'Step', definition: 'Unidad de ejecución dentro de un job - READ, PROCESS, WRITE', example: 'Leer datos → Transformar → Guardar' },
    { title: 'ItemReader', definition: 'Lee datos en chunks desde fuente', example: 'CSV, DB, XML, JSON' },
    { title: 'ItemProcessor', definition: 'Procesa/transforma cada item', example: 'Validar, convertir formato, enriquecer datos' },
    { title: 'ItemWriter', definition: 'Escribe items procesados a destino', example: 'BD, archivo, cola mensajes' },
  ];
