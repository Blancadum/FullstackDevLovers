...
export function LessonSpringSecurityAdvanced() {
  ...
  const concepts = [
    { title: 'Authentication', definition: 'Verificar QUIÉN eres (login con credenciales)', example: 'Login/Password, OAuth2, SAML' },
    { title: 'Authorization', definition: 'Verificar QUÉ puedes hacer (permisos)', example: 'Role-based (ADMIN), Attribute-based (datos)' },
    { title: 'Principal', definition: 'Usuario/entidad autenticada en SecurityContext', example: 'Username, JWT, OAuth token' },
    { title: 'Roles vs Authorities', definition: 'Roles son grupos de permisos; Authorities son permisos específicos', example: 'ROLE_ADMIN tiene AUTHORITY_DELETE_USER' },
  ];
