    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Tipos de Datos', description: 'Primitivos e Wrappers: int, double, boolean, String y conversiones', link: '/backend/java/basico/tipos-datos' },
          { title: 'Control de Flujo', description: 'If/else, switch, bucles (for, while) y flujo de ejecución', link: '/backend/java/basico/control-flujo' },
          { title: 'Strings y Texto', description: 'Manipulación de cadenas, métodos útiles y StringBuilder', link: '/backend/java/basico/strings' },
          { title: 'Arrays y Matrices', description: 'Arreglos unidimensionales y bidimensionales, iteración', link: '/backend/java/basico/arrays' },
          { title: 'Scanner e Entrada', description: 'Lectura de entrada del usuario desde consola', link: '/backend/java/basico/scanner' },
          { title: 'Excepciones', description: 'Try/catch/finally, tipos de excepciones y manejo de errores', link: '/backend/java/basico/excepciones' },
          { title: 'Operadores', description: 'Operadores aritméticos, lógicos, comparación y asignación', link: '/backend/java/basico/operadores' },
        ]},
      {
        id: 'oop',
        ...
        lessons: [
          { title: 'Clases y Objetos', description: 'Definición, atributos, métodos, constructores y encapsulación', link: '/backend/java/poo/clases-objetos' },
          { title: 'Herencia', description: 'Extensión de clases, super(), método toString() y reuso de código', link: '/backend/java/poo/herencia' },
          { title: 'Polimorfismo', description: 'Sobreescritura de métodos, ligadura dinámica y flexibilidad de código', link: '/backend/java/poo/polimorfismo' },
          { title: 'Interfaces y Clases Abstractas', description: 'Contratos, abstracción y múltiple herencia con interfaces', link: '/backend/java/poo/interfaces-abstractas' },
        ]},
      {
        id: 'avanzado',
        ...
        ]},
      {
        ...
        lessons: [
          { title: 'JDBC - Conectar a Bases de Datos', description: 'DriverManager, Connection, Statement, ResultSet y operaciones SQL', link: '/backend/java/bd/jdbc' },
          { title: 'CRUD y Transacciones', description: 'Operaciones Create, Read, Update, Delete y gestión de transacciones', link: '/backend/java/bd/crud' },
        ]},
    ],
    lessons: [
      ...
      { title: 'Operadores', link: '/backend/java/basico/operadores' },
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción a MongoDB y NoSQL', link: '/mongodb/introduccion' },
          { title: 'MongoDB vs SQL - Comparativa', link: '/mongodb/comparativa' },
          { title: 'Documentos y Colecciones', link: '/mongodb/documentos' },
        ]},
      {
        id: 'operaciones',
        ...
        lessons: [
          { title: 'Insertar Documentos (Create)', link: '/mongodb/operaciones/create' },
          { title: 'Consultar Documentos (Read)', link: '/mongodb/operaciones/read' },
          { title: 'Actualizar Documentos (Update)', link: '/mongodb/operaciones/update' },
          { title: 'Eliminar Documentos (Delete)', link: '/mongodb/operaciones/delete' },
        ]},
      {
        id: 'consultas',
        name: 'Consultas Avanzadas',
        ...
        lessons: [
          { title: 'Filtros y Operadores de Consulta', link: '/mongodb/consultas/filtros' },
          { title: 'Agregación con Pipeline', link: '/mongodb/consultas/agregacion' },
          { title: 'Indexación y Optimización', link: '/mongodb/consultas/indexacion' },
        ]},
      {
        id: 'modelado',
        ...
        lessons: [
          { title: 'Esquemas en MongoDB', link: '/mongodb/modelado/esquemas' },
          { title: 'Relaciones: Embedding vs Referencing', link: '/mongodb/modelado/relaciones' },
          { title: 'Validación de Documentos', link: '/mongodb/modelado/validacion' },
        ]},
    ],
    lessons: [
      { title: 'Introducción a MongoDB y NoSQL', link: '/mongodb/introduccion' },
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción a HTML', link: '/html/introduccion' },
          { title: 'Estructura básica de un documento', link: '/html/estructura' },
          { title: 'Etiquetas y elementos', link: '/html/etiquetas' },
        ]},
      {
        id: 'formularios',
        name: 'Formularios',
        ...
        lessons: [
          { title: 'Formularios HTML', link: '/html/formularios' },
          { title: 'Validación de formularios', link: '/html/validacion' },
        ]},
    ],
    lessons: [
      { title: 'Introducción a HTML', link: '/html/introduccion' },
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción a CSS', link: '/css/introduccion' },
          { title: 'Selectores y propiedades', link: '/css/selectores' },
          { title: 'Modelo de caja (Box Model)', link: '/css/box-model' },
        ]},
      {
        id: 'layouts',
        name: 'Layouts',
        ...
        lessons: [
          { title: 'Flexbox - Layouts flexibles', link: '/css/flexbox' },
          { title: 'CSS Grid - Layouts avanzados', link: '/css/grid' },
          { title: 'Diseño responsivo', link: '/css/responsive' },
        ]},
    ],
    lessons: [
      { title: 'Introducción a CSS', link: '/css/introduccion' },
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción a React', description: 'Qué es React, por qué usarlo y cómo funciona la biblioteca', link: '/react/fundamentos/introduccion' },
          { title: 'JSX y Componentes', description: 'Aprende JSX, componentes funcionales y cómo organizar tu código', link: '/react/fundamentos/jsx-componentes' },
          { title: 'Props y Estado', description: 'Cómo pasar datos entre componentes y gestionar el estado interno', link: '/react/fundamentos/props-estado' },
        ]},
      {
        id: 'hooks',
        name: 'Hooks',
        ...
        lessons: [
          { title: 'useState Hook', description: 'Gestiona estado en componentes funcionales con useState', link: '/react/hooks/usestate' },
          { title: 'useEffect Hook', description: 'Ejecuta efectos secundarios y ciclos de vida con useEffect', link: '/react/hooks/useeffect' },
          { title: 'Hooks personalizados', description: 'Crea tus propios hooks reutilizables', link: '/react/hooks/custom' },
        ]},
    ],
    lessons: [
      { title: 'Introducción a React', link: '/react/fundamentos/introduccion' },
      { title: 'JSX y Componentes', link: '/react/fundamentos/jsx-componentes' },
      { title: 'Props y Estado', link: '/react/fundamentos/props-estado' },
      { title: 'useState Hook', link: '/react/hooks/usestate' },
      { title: 'useEffect Hook', link: '/react/hooks/useeffect' },
      { title: 'Hooks personalizados', link: '/react/hooks/custom' },
    ]},
  {
    id: 'angular',
    name: 'Angular',
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción a Bootstrap', link: '/bootstrap/introduccion' },
          { title: 'Sistema de Grid', link: '/bootstrap/grid' },
          { title: 'Componentes básicos', link: '/bootstrap/componentes' },
        ]},
      {
        id: 'componentes',
        name: 'Componentes',
        ...
        lessons: [
          { title: 'Botones y formularios', link: '/bootstrap/botones-formularios' },
          { title: 'Navbars y menús', link: '/bootstrap/navbars' },
          { title: 'Cards y layouts', link: '/bootstrap/cards' },
        ]},
    ],
    lessons: [
      { title: 'Introducción a Bootstrap', link: '/bootstrap/introduccion' },
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción a Tailwind CSS', link: '/tailwindcss/introduccion' },
          { title: 'Utility Classes', link: '/tailwindcss/utilities' },
          { title: 'Responsive Design', link: '/tailwindcss/responsive' },
        ]},
      {
        id: 'componentes',
        name: 'Componentes',
        ...
        lessons: [
          { title: 'Creación de componentes', link: '/tailwindcss/componentes' },
          { title: 'Customización', link: '/tailwindcss/customizacion' },
          { title: 'Temas y configuración', link: '/tailwindcss/temas' },
        ]},
    ],
    lessons: [
      { title: 'Introducción a Tailwind CSS', link: '/tailwindcss/introduccion' },
