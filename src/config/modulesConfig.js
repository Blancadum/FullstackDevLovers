...
export const modulesWithLessons = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { title: 'Comparación: EC2 vs Lambda', link: '/aws/comparacion-ec2-vs-lambda', icon: '🔄' },
          { title: 'DynamoDB - Base de Datos NoSQL', link: '/aws/servicios/dynamodb', icon: '🔑' },
          { title: 'Comparación: RDS vs DynamoDB', link: '/aws/comparacion-rds-vs-dynamodb', icon: '🔄' },
    ...
    lessons: [
      ...
      { title: 'Comparación: EC2 vs Lambda (Aclarando Confusiones)', link: '/aws/comparacion-ec2-vs-lambda' },
      { title: 'DynamoDB - Base de Datos NoSQL', link: '/aws/servicios/dynamodb' },
      { title: 'Comparación: RDS vs DynamoDB (SQL vs NoSQL)', link: '/aws/comparacion-rds-vs-dynamodb' },
  ...
  },
  {
    ...
    sections: [
      {
        ...
        lessons: [
          ...
          { title: 'Comparación: Docker vs Kubernetes', link: '/docker/comparacion-docker-vs-kubernetes', icon: '🔄' },
        ],
      },
      {
        id: 'composicion',
    ...
    lessons: [
      ...
      { title: 'Comparación: Docker vs Kubernetes (Contenedor vs Orquestador)', link: '/docker/comparacion-docker-vs-kubernetes' },
    ...
    sections: [
      {
        ...
        lessons: [
          { title: 'Introducción: Qué es Kubernetes', link: '/kubernetes/fundamentales/intro', icon: '☸️' },
          { title: 'Pods: La unidad más pequeña', link: '/kubernetes/fundamentales/pods', icon: '📦' },
          { title: 'Deployments: Gestión de réplicas', link: '/kubernetes/fundamentales/deployments', icon: '🚀' },
        ],
      },
    ],
    lessons: [
      { title: 'Introducción: Qué es Kubernetes', link: '/kubernetes/fundamentales/intro' },
      { title: 'Pods: La unidad más pequeña', link: '/kubernetes/fundamentales/pods' },
      { title: 'Deployments: Gestión de réplicas', link: '/kubernetes/fundamentales/deployments' },
      { title: 'Comparación: Docker vs Kubernetes (Aclarando Confusiones)', link: '/docker/comparacion-docker-vs-kubernetes' },
    ],
  },
  {
    id: 'git',
