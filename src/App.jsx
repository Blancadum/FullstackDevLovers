...
import { LandingSQL } from './pages/LandingSQL';
    ...
    <>
      ...
      <main style={{ flex: 1 }}>
        <Routes>
          ...
          <Route path="/sql/landing" element={<LandingSQL />} />
          <Route path="/metodologias/landing" element={<LandingMetodologias />} />
          <Route path="/proyecto/landing" element={<LandingProyecto />} />
