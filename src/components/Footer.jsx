...
export function Footer() {
  return (
    <footer>
      <p>
        © 2026. Web de aprendizaje generada por IA: puede contener errores. Autora: Blanca de Uña Martín.
        <span className="footer-icons">
          <a href="https://www.linkedin.com/in/blanca-de-uña-martin/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
